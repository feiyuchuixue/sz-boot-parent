...
--comment: 新增登陆日志菜单
INSERT INTO `sys_menu` (`id`, `pid`, `path`, `name`, `title`, `icon`, `component`, `redirect`, `sort`, `deep`, `menu_type_cd`, `permissions`, `is_hidden`, `has_children`, `is_link`, `is_full`, `is_affix`, `is_keep_alive`, `create_time`, `update_time`, `create_id`, `update_id`, `del_flag`, `delete_id`, `delete_time`, `use_data_scope`) VALUES ('191878090b294ec5892a68081dd91428', '88b2e5def2ff474fa8bf3537d4a2fe5b', '/system/sysLoginLog', 'SysLoginLogView', '登陆日志', 'Location', '/system/sysLoginLog/index', '', 1100, 1, '1002002', 'sys.login.log.query_table', 'F', 'T', 'F', 'F', 'F', 'F', NULL, NULL, NULL, NULL, 'F', NULL, NULL, 'F');
...
--comment: 新增登陆状态字典
INSERT INTO `sys_dict_type` (`id`, `type_name`, `type_code`, `is_lock`, `is_show`, `del_flag`, `remark`, `create_time`, `update_time`, `delete_time`, `create_id`, `update_id`, `delete_id`, `type`) VALUES (1009, '登陆状态', 'login_status', 'F', 'T', 'F', '', '2025-07-29 22:49:03', '2025-07-29 22:49:03', NULL, 1, 1, NULL, 'system');
INSERT INTO `sys_dict` (`id`, `sys_dict_type_id`, `code_name`, `alias`, `sort`, `callback_show_style`, `remark`, `is_lock`, `is_show`, `del_flag`, `create_time`, `update_time`, `delete_time`, `create_id`, `update_id`, `delete_id`) VALUES (1009002, 1009, '登陆失败', '', 1, 'danger', '', 'F', 'T', 'F', '2025-07-29 22:49:34', '2025-07-29 22:49:34', NULL, 1, 1, NULL);
INSERT INTO `sys_dict` (`id`, `sys_dict_type_id`, `code_name`, `alias`, `sort`, `callback_show_style`, `remark`, `is_lock`, `is_show`, `del_flag`, `create_time`, `update_time`, `delete_time`, `create_id`, `update_id`, `delete_id`) VALUES (1009001, 1009, '登陆成功', '', 1, 'success', '', 'F', 'T', 'F', '2025-07-29 22:49:22', '2025-07-29 22:49:22', NULL, 1, 1, NULL);
